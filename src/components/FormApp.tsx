...
export default function FormApp({ onLogout }: { onLogout: () => void }) {
        ...
        <div className="max-w-lg mx-auto">
          <div className="flex items-center justify-between mb-1">
            ...
            <div className="flex items-center gap-4">
              ...
              <button onClick={onLogout} className="text-xs font-bold text-white bg-sky-600 px-2 py-1 rounded">Logout</button>
            </div>
          </div>
